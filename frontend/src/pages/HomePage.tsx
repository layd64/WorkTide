    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <div className="relative bg-indigo-800 w-full">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          <MotionWrapper type="fadeIn" duration={0.8}>
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
              {user ? 'Welcome!' : t('hero.title')}
            </h1>
          </MotionWrapper>
          <MotionWrapper type="slideUp" delay={0.2} duration={0.8}>
            <p className="mt-6 text-xl text-indigo-100 max-w-3xl mx-auto">
              {t('hero.subtitle')}
            </p>
          </MotionWrapper>
          <MotionWrapper type="scaleIn" delay={0.4} duration={0.6}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              {/* Step 1 */}
              <MotionWrapper type="scaleIn" delay={0.1}>
              ...
              {/* Step 2 */}
              <MotionWrapper type="scaleIn" delay={0.2}>
                <div className="text-center">
                  <div className="flex items-center justify-center h-16 w-16 rounded-full mx-auto bg-indigo-200 text-indigo-800">
              ...
              {/* Step 3 */}
              <MotionWrapper type="scaleIn" delay={0.3}>
                <div className="text-center">
                  <div className="flex items-center justify-center h-16 w-16 rounded-full mx-auto bg-indigo-200 text-indigo-800">
